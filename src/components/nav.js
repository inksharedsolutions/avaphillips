...
import Logo from '../static/logo/logo-name.png'
    ...
    return(
        <>
            <nav>
                <div className="wrapper">
                    ...
                    <ul>
                        ...
                        <li><Link to="/about-the-author" className="nav-links">Author</Link></li>
                        <li><Link to="/about-the-book" className="nav-links">Books</Link></li>
            ...
            <div className={toggled? "toggle-nav": "toggle-nav-hide"}>
                ...
                <Link to="/about-the-book" className="toggle-nav-links">Books</Link>
                <Link to="/about-the-author" className="toggle-nav-links">Author</Link>
